...
<head>
	<title>Privacy Policy - Dunda Football</title>
	<!-- META -->
	<meta charset="utf-8">
    ...
    <meta property="og:title" content="Privacy Policy | Dunda Football" />
    <meta property="og:description" content="Privacy Policy | Dunda Football" />
    ...
    <meta property="twitter:title" content="Privacy Policy | Dunda Football">
    <meta property="twitter:description" content="Dunda Football's privacy policy.">
...
<body class="theme-3 theme3_bg">
	...
	<div class="inner_table shadow5 layout3 white_bg">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="bridcrumb">	<a href="#">Home</a> / Privacy Policy</div>
				</div>
			</div>
...
<!--						</div>-->
                        ...
                        <strong>Privacy Policy of dundafootball.com</strong>
                        <p>
                            ...
                            Owner contact email: dundafootball@gmail.com<br><br>

                            <strong>Types of Data collected</strong><br>
                            <i>The owner does not provide a list of Personal Data types collected.</i><br><br>
                            ...
                            <ul>
                                ...
                                <li>The Owner takes appropriate security measures to prevent unauthorized access, disclosure, modification, or unauthorized destruction of the Data.</li>
                                <li>The Data processing is carried out using computers and/or IT enabled tools, following organizational procedures and modes strictly related to the purposes indicated. In addition to the Owner, in some cases, the Data may be accessible to certain types of persons in charge, involved with the operation of this Application (administration, sales, marketing, legal, system administration) or external parties (such as third-party technical service providers, mail carriers, hosting providers, IT companies, communications agencies) appointed, if necessary, as Data Processors by the Owner. The updated list of these parties may be requested from the Owner at any time.</li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>In any case, the Owner will gladly help to clarify the specific legal basis that applies to the processing, and in particular whether the provision of Personal Data is a statutory or contractual requirement, or a requirement necessary to enter into a contract.</li>
                            </ul>
                            ...
                            <ul>
                                <li>Legal action</li>
                                <li>The User's Personal Data may be used for legal purposes by the Owner in Court or in the stages leading to possible legal action arising from improper use of this Application or the related Services.</li>
                                <li>The User declares to be aware that the Owner may be required to reveal personal data upon request of public authorities.</li>
                            </ul>
