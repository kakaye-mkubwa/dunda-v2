...
<head>
    ...
    <title>Add Post - Dunda Football Admin</title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <form id="add-article-form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="post_title" name="title" class="form-control" placeholder="Enter post title" required autofocus>
                                    </div>
                                </div>
                                <label for="post_description">Description</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="post_description" name="description" class="form-control" placeholder="Enter post description" required autofocus>
                                    </div>
                                </div>
...
<!--                                    </div>-->
                        ...
                        <button id="add-article-btn" class="btn btn-block bg-pink waves-effect" type="submit">Add Article</button>
                    </div>
                </div>
            </div>
            <!-- #END# CKEditor -->
