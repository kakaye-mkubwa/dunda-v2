...
if (isset($_GET['tag'])){
    ...
    if ($tagPresentFlag){
        $tagPosts = json_decode($postsFunctions->fetchPostsByTag($tagName),true)['data'];
        ?>
        <!DOCTYPE html>
        <html lang="en">

        <head>
            <title><?=$tagName?> - Dunda Football</title>
            <!-- META -->
            <meta charset="utf-8">
        ...
        <div class="archives layout3 post post1 padding-top-30">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="bridcrumb">	<a href="../home">Home</a> / Tag / <?=$tagName?></div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="categories_title">
                                    <h5>Tag: <a href="<?='../tag/'.$tagName?>"><?=ucfirst($tagName)?></a></h5>
                                </div>
                            </div>
                        </div>
                                    ...
                                    for ($i = 0;$i < 5;$i++){
                                        ...
                                        <div class="single_post type10 type16 widgets_small mb15">
                                            ...
                                            <div class="single_post_text">
                                                ...
                                                <div class="meta4">	<a href="<?='../category/'.$row[$i]['category']?>"><?=$row[$i]['category']?></a>
                                                </div>
                                ...
                                <div class="popular_items">
                                    ...
                                    for ($i = 5;$i < 10;$i++){
                                        ...
                                        <div class="single_post type10 type16 widgets_small mb15">
                                            ...
                                            <div class="single_post_text">
                                                <h4><a href="news.php"><?=$row[$i]['post_title']?></a></h4>
                                                <div class="meta4">	<a href="<?='../category/'.$row[$i]['category']?>"><?=$row[$i]['category']?></a>
                                                </div>
                                                <div class="space-5"></div>
                                                <div class="border_black"></div>
